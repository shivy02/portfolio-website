...
export default function Home() {
  return (
    ...
    <div className="relative min-h-screen w-full bg-background">
      ...
      <div className="z-1 absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-6/7 w-[60vw] h-[80vh] md:w-[50vw] md:h[90vh] rounded-full blur-3xl bg-gradient-to-r via-purple-400/70 from-orange-400/70 to-blue-400/70 dark:via-purple-400/50 dark:from-orange-400/50 dark:to-blue-400/50 mixed-blend-multiply"></div>
